    ...
    def load_from_disk(self) -> None:
        ...
        try:
            ...
            if len(loaded_metadata) != loaded_index.ntotal:
                ...
                # We do not raise, we let it load but log warning
            ...
            logger.error(f"Error loading persisted FAISS files: {str(e)}. Reverting to empty initialized state.", exc_info=True)
            self._index = faiss.IndexFlatIP(self.dimension)
            self._metadata_store = {}
